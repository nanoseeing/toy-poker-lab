"""Plugin registration for the two-street integer range game."""

from toy_poker.games.base import GamePlugin
from toy_poker.games.integer_range_betting_two_street import game as _game  # noqa: F401
from toy_poker.games.integer_range_betting_two_street.metadata import METADATA
from toy_poker.games.registry import register_game


class IntegerRangeBettingTwoStreetPlugin(GamePlugin):
    ...
    def information_label(self, key: str) -> str:
        ...
        readable = (
            history.replace("STREET_2", "street 2")
            .replace("RAISE_ALL_IN", "raise all-in")
...
PLUGIN = IntegerRangeBettingTwoStreetPlugin()
