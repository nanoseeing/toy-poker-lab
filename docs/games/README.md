...
| `integer_range_betting_two_street` | 1〜N weighted rangeを同じrankのまま2 streetプレイ | [`integer_range_betting_two_street_cfr_plus.toml`](../../configs/experiments/integer_range_betting_two_street_cfr_plus.toml) | [ルールと解析方法](integer_range_betting_two_street.md) | [Report](../../public/results/integer_range_betting_two_street/report.md) / [Viewer](../../public/results/integer_range_betting_two_street/strategy_viewer.html) |
