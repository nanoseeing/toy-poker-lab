...
def current_node_ev(root_utility_ev: float, committed: float) -> float:
    """Rebase a root-relative utility EV so prior committed chips are sunk."""
